...
- Require canonical non-sentinel UUIDv4 for the public `tenant_record_id` and for every trust-bearing reference suffix; UUIDv1 and other UUID versions now fail closed.
...
- Reject timestamp/node-bearing UUIDv1 tenant/reference identities as well as human-readable/value-bearing reference metadata before serialization.
