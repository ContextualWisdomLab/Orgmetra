...
If a result cannot be bound, do not copy a score or participant identifier around the contract. Verify the exact Psychometrics Commons revision and result snapshot, re-establish the authorized candidate-to-participant binding, and obtain a human reviewer before the evidence is used by any Orgmetra decision workflow.
