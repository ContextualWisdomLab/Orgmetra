"""Regression tests for the separation-review quality-gate trigger surface."""

from pathlib import Path


_WORKFLOW_PATH = Path(".github/workflows/employment-separation-review-quality.yml")
...
def test_quality_workflow_retriggers_on_shared_test_configuration() -> None:
    ...
    for path in _SHARED_TEST_CONFIGURATION:
        assert f'- "{path}"' in workflow, (
            ...
            "Employment Separation Review Quality"
        )
