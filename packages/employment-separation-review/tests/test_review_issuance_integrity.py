"""Focused regressions for process-local separation-review issuance integrity."""
...
from orgmetra_employment_separation_review import packet as packet_module


def _packet():
    """Build one standalone reviewed packet without cross-test fixture coupling."""
...
def test_missing_process_local_review_issuance_evidence_fails_closed() -> None:
    packet = _packet()
    packet_module._discard_review_seal(id(packet))
