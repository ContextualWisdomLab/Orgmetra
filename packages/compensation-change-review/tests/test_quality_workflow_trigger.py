"""Regression tests for the compensation-review quality-gate trigger surface."""

from pathlib import Path


_WORKFLOW_PATH = Path(".github/workflows/compensation-change-review-quality.yml")
...
def test_quality_workflow_retriggers_on_shared_test_configuration() -> None:
    ...
    for path in _SHARED_TEST_CONFIGURATION:
        assert f'- "{path}"' in workflow, (
            ...
            "Compensation Change Review Quality"
        )
