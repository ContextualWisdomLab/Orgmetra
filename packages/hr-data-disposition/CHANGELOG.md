...
- Reject caller-defined scalar subclasses, malformed/noncanonical references, stale upstream retention states, active holds, due-date/non-post-due requests, same-actor review, and post-construction evidence mutation.
