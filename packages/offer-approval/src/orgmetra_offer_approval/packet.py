...
_NEXT_ACTION = (
    "Verify authoritative Job/Position scope, selected-candidate evidence, "
    "compensation-package provenance, and offer-terms provenance; then record accountable "
    "human approval through the authoritative offer workflow before communicating or "
    "executing the offer."
)
