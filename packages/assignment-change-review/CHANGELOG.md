...
- Canonical non-sentinel UUIDv4 suffixes for every namespaced trust reference, rejecting UUIDv1 timestamp/node correlation metadata and other UUID versions.
