...
- Canonical non-sentinel UUIDv4 identity for `tenant_record_id` and every namespaced trust reference, rejecting UUIDv1 timestamp/node correlation metadata and other UUID versions.
