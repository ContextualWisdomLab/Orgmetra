...
from orgmetra_hris_kernel import AssignmentPortfolioError, validate_assignment_portfolio

from .conftest import JORDAN, JORDAN_EMPLOYMENT, TENANT, utc
...
def test_portfolio_rejects_decimal_subclass_before_ratio_comparisons(
    ...
    """Caller-controlled Decimal behavior must not decide an Assignment invariant."""
    forged = replace(
        jordan_icu_assignment,
