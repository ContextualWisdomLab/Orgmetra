...
- Seal the creation-time canonical evidence digest in a process-local weak registry outside packet-writable state and reject later replacement even when the replacement policy digest, actor, date, or legal-hold evidence is independently well-formed.
