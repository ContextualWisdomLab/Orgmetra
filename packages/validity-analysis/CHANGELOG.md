...
- Keep durable owner-side typed-receipt and auxiliary-authority resolution plus released auxiliary evidence exchange explicitly incomplete under #407; the scientific leaf preserves the complete opaque correlation tuple but does not self-authenticate it.
