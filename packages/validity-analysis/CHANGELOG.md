...
- Make result verification explicit: converged results serialize as `verified`, while completed nonconverged results serialize as `not_verifiable` and retain their failure diagnostics instead of looking like a scientific GREEN.
