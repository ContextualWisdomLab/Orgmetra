...
- Revalidate every trust-bearing scalar's exact built-in runtime type at canonical export so low-level post-issuance replacement with a representation-preserving caller subtype fails closed before evidence leaves the package.
