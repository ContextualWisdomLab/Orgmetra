"""Regression for the read-only Keyverse opaque identity-reference contract."""
...
def test_accepts_non_uuid_keyverse_identity_references() -> None:
    """Do not invent a UUIDv4 requirement for externally owned identity evidence."""
    packet = build_candidate_offer_response(
        ...
        identity_resolution_reference="identity_resolution:keyverse.subject~v1",
    ...
    assert evidence["identity_resolution_reference"] == "identity_resolution:keyverse.subject~v1"
