...
- Add adversarial runtime-type, weak-control, stale-control, audit-latency, scope-mismatch, chronology, audit-binding, direct-construction, and post-issuance mutation regressions plus exact 100% owned statement/branch coverage and hash-bound isolated-wheel verification.
