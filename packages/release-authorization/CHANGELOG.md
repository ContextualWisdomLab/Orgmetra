...
- Require control verification to be no more than 60 seconds old at authorization time; a syntactically valid stale control snapshot now fails closed.
...
- Add adversarial runtime-type, weak-control, stale-control, scope-mismatch, chronology, audit-binding, direct-construction, and post-issuance mutation regressions plus exact 100% owned statement/branch coverage and hash-bound isolated-wheel verification.
