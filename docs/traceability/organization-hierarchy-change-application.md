...
| Hierarchy audit provenance names the owning bounded context | migration 0029 emits hierarchy CloudEvents with `source=urn:orgmetra:organization_core` | persisted `audit_event_record.canonical_event_json` source assertion |
