...
| Prevent reference fields from becoming a PII/value smuggling channel | Every trust-bearing reference is the expected namespace plus canonical non-sentinel UUID | `test_invalid_core_inputs_fail_closed`, `test_every_reference_and_digest_is_validated` |
