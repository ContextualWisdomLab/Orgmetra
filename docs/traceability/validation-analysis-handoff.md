...
| Typed adjustment congruence | known nonresponse and calibration/raking/post-stratification adjustment codes must identify the matching typed receipt family through `evidence_kind` | `test_specialized_adjustments_require_matching_evidence_kind` |
