...
| Preserve tenant and accountable reviewer context | canonical operational tenant UUID plus UUID-backed `actor:` reviewer reference, purpose and reason | reserved/noncanonical UUID, malformed reference, and governance-code regressions |
