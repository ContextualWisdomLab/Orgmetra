...
| Tenant/study/actor governance | canonical UUIDv4 tenant plus namespaced opaque Orgmetra references | UUIDv1/noncanonical/wrong-namespace regressions | implemented_on_active_pr |
