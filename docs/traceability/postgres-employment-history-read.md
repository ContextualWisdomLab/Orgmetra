...
The immutable connection-capability binding prevents a dependency that passed construction-time validation from being swapped through ordinary post-construction slot mutation before execution. It does not claim sandboxing or protection from arbitrary trusted-process code that can fabricate Python objects outside supported constructors.
