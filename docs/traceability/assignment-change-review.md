...
| Version high-impact actor/purpose/reason evidence | bounded positive `evidence_version` is included in canonical JSON/SHA-256 | `test_packet_carries_explicit_evidence_version`, version range and digest-change regressions | active PR |
