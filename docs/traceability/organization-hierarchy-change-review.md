...
The packet runtime type is checked before any trust-bearing field is read. This prevents a caller-defined packet subclass from changing attribute resolution between validation and canonical emission; exact primitive checks remain a second boundary against scalar runtime substitution.
