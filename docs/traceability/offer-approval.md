...
| Human accountability | distinct-actor test; immutable-state tests | Requester and approver differ; human approval is mandatory. |
...
referenced evidence is substantively correct, that compensation is lawful/fair, that a human
approved the offer, or that an offer was delivered.
