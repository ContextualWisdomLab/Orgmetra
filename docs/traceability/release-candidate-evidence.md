...
| Local exact dependency linkage | checked-in project plus another project declaring its exact version | one local component retains source path, declaration, strongest scope, and declaring-project edge | implemented_on_active_pr |
