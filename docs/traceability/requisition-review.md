...
| Preserve accountable human actors | `hiring_manager_actor_reference`, `approver_actor_reference` | actor namespace validation and direct-constructor contract |
