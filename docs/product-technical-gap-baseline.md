...
| PostgreSQL contracts | `tests/test_job_analysis_snapshot_postgres.sh` passed on exact local head `48ce063d057f1ca2793f62c3e40cfcda9a84df52` against disposable PostgreSQL `16.14`; the full hosted PostgreSQL matrix remains the authoritative release gate. |
