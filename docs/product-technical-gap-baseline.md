...
- **PR #124** owns hardware-acceleration ADR security hardening at exact head `40caf5f1fb154639b24479a775c772daa8250543`; its exact-head hosted suite has terminal `opencode-review` FAILURE, no qualifying independent approval, and remains active-PR truth despite being Ready-for-review.
