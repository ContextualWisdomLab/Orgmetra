...
- Cutover has an explicit transaction-drain linearization point and a deterministic legacy Assignment-to-confirmed-reservation mapping across the complete currently authoritative effective-time domain, including past slices required for retroactive correction.
