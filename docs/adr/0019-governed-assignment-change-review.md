...
2. represents trust-bearing HR and evidence identities only as expected-namespace canonical non-sentinel UUIDv4 references, rejecting UUIDv1 and every other UUID version, with lowercase SHA-256 digests for evidence artifacts;
