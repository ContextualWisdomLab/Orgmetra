...
- A post-issuance runtime subtype cannot preserve evidence authority solely by keeping canonical JSON bytes unchanged; exact built-in runtime types are re-established before canonical export invokes field behavior.
