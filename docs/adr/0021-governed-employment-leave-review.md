...
- UUIDv1 timestamp/node correlation cannot enter tenant identity or namespaced trust references; UUIDv4 remains only an opaque syntax constraint, not proof of tenant or worker scope.
