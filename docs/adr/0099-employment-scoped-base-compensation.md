...
Concurrent employments can carry independent base-compensation truth without conflating one Person's employment terms. Historical corrections remain reconstructable across business time and system-recorded time, while a client cannot backdate the system-knowledge start or choose the system-knowledge closure instant of a compensation fact. The model is deliberately limited to base compensation: bonus, equity, allowance, payroll calculation, taxation, and total-rewards valuation are not implied by these relations.
