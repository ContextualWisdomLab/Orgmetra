...
4. Automated exclusion or recommendation suppression must not make an affected worker or option invisible to the reviewer who is expected to provide substantive oversight, unless a separately reviewed versioned policy expressly authorizes that stage and the resulting path remains reconstructable and reviewable under the applicable rights contract. A later confirmation cannot convert an irreversible automated exclusion into substantively human-supervised provenance.
