...
7. records high-impact human-confirmed audit/outbox evidence in the same transaction and identifies the producing bounded context as `urn:orgmetra:organization_core`;
