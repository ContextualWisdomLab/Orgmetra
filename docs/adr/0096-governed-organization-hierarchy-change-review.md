...
8. rejects caller-defined runtime subclasses both for the packet container before any trust-bearing field read and at trust-bearing primitive boundaries, so validation and canonical emission cannot observe different attacker-controlled values;
