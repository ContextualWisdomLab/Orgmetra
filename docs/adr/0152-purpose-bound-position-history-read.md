...
5. Business-effective intervals are also half-open. Two versions visible at the same knowledge instant may not claim overlapping business truth for the same Position.
...
- Bitemporal contradictions fail closed at the service boundary.
