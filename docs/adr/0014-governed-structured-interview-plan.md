...
- canonical UUIDv4 tenant identity and one UUIDv4-backed opaque interview-plan reference;
...
- UUIDv1/time-node-bearing tenant/reference identities and value-bearing trust-reference suffixes cannot enter portable evidence.
