...
- Constructor-bypassing `object.__new__` clones and direct class-allocator calls cannot mint creation-bound plan issuance evidence merely by copying valid fields and invoking `__post_init__()`.
