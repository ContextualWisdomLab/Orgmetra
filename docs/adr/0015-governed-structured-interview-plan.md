...
- Constructor-bypassing `object.__new__` clones cannot mint creation-bound plan issuance evidence merely by copying valid fields and invoking `__post_init__()`.
