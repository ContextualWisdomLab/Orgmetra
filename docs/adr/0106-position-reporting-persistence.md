...
- the version table carries only evidence needed to prove reviewed application: SHA-256 review/application digests, pseudonymous reviewer and applying actors, review time, immutable audit correlation, and fixed application state;
