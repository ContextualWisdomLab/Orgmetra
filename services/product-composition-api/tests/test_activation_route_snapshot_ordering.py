...
def test_recovered_route_snapshot_uses_canonical_route_order_not_input_tuple_order() -> None:
    ...
    snapshot = _issue_route_snapshot(recovered)

    assert snapshot.available_route_ids == ("people_get", "workforce_validation")
