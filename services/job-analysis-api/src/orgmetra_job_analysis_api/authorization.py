"""Delegate job-analysis field access to Orgmetra's integrated policy evaluator."""
...
def authorize_resource_fields(
    *,
    ...
    """Authorize one exact job-analysis resource without duplicating policy logic.

    The API contributes only request-edge identity/scope attributes and the
    resolved target. The Keyverse adapter remains the single owner of
    tenant/resource/purpose/operation/scope/field evaluation.
    """
