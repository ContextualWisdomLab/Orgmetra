...
The transport accepts at most 64 ASGI header frames and at most 16 KiB of
aggregate header-name and header-value bytes before lower-casing or dictionary
allocation. Requests above either budget fail closed as authentication failures;
they do not reach the identity provider, authorization policy, request body, or
