...
class CalibrationAdjustmentAuthorityView:
    ...
    def __setattr__(self, name: str, value: object) -> None:
        ...
        raise AttributeError("CalibrationAdjustmentAuthorityView is immutable.")
...
def resolve_calibration_adjustment_authority(
    *,
    ...
    try:
        ...
        raise CalibrationAdjustmentAuthorityIntegrityError(
            "owner port returned malformed calibration-adjustment authority evidence"
        ) from exc
    if record != persisted:
        raise CalibrationAdjustmentAuthorityIntegrityError(
            "owner port returned non-canonical calibration-adjustment authority evidence"
