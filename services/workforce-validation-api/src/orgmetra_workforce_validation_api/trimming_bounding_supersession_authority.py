...
class TrimmingBoundingSupersessionAuthorityView:
    ...
    def _require_issued(self) -> None:
        ...
        _require_trimming_bounding_supersession_view_issued(self)
...
def _resolve_trimming_bounding_supersession_authority_state(
    *,
    ...
    """Authorize and resolve trimming supersession into inert projection state."""
...
def _build_trimming_bounding_supersession_view_runtime():
    ...
    def require_issued(view: TrimmingBoundingSupersessionAuthorityView) -> None:
    ...
    def resolve(
        *,
        ...
        tenant_identity, study_identity, fields = (
            _resolve_trimming_bounding_supersession_authority_state(
                principal=principal,
...
(
    _require_trimming_bounding_supersession_view_issued,
    resolve_trimming_bounding_supersession_authority,
) = _build_trimming_bounding_supersession_view_runtime()
del _build_trimming_bounding_supersession_view_runtime
