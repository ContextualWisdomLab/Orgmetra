...
def _resolve_weight_variance_authority_state(
    *,
    ...
    persisted = read_capability(
        ...
        variance_method_reference=method_ref,
        variance_method_version=method_version,
        variance_evidence_mode=evidence_mode,
