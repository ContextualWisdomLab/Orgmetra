...
class ValidationResultSupersessionAuthorityView:
    """Sealed current-result authority issued only after purpose authorization."""
    ...
    def __setattr__(self, name: str, value: object) -> None:
        ...
        raise AttributeError("ValidationResultSupersessionAuthorityView is immutable.")
    ...
    def _require_issued(self) -> None:
        ...
        _require_validation_result_supersession_view_issued(self)
...
def _resolve_validation_result_supersession_authority_state(
    *,
    ...
    """Authorize and resolve validation-result supersession into inert projection state."""
...
def _build_validation_result_supersession_view_runtime():
    ...
    def require_issued(view: ValidationResultSupersessionAuthorityView) -> None:
    ...
    def resolve(
        *,
        ...
        tenant_identity, study_identity, fields = (
            _resolve_validation_result_supersession_authority_state(
                principal=principal,
...
(
    _require_validation_result_supersession_view_issued,
    resolve_validation_result_supersession_authority,
) = _build_validation_result_supersession_view_runtime()
del _build_validation_result_supersession_view_runtime
