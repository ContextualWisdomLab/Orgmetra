...
def _resolve_calibration_support_authority_state(
    *,
    ...
    try:
        ...
        raise CalibrationSupportAuthorityIntegrityError(
            "owner port returned structurally invalid calibration support authority evidence"
        ) from exc
    if record != persisted:
        raise CalibrationSupportAuthorityIntegrityError(
            "owner port returned non-canonical calibration support authority structure"
        )
