...
class BaseWeightSupersessionAuthorityView:
    ...
    def __setattr__(self, name: str, value: object) -> None:
        ...
        raise AttributeError("BaseWeightSupersessionAuthorityView is immutable.")
    ...
    def _require_issued(self) -> None:
        ...
        _require_base_weight_supersession_view_issued(self)
...
def _resolve_base_weight_supersession_authority_state(
    *,
    ...
    """Authorize and resolve base-weight supersession into inert projection state."""
...
def _build_base_weight_supersession_view_runtime():
    """Create closure-private sealing state and the authorized public resolver."""
    issuance_marker = object()

    def require_issued(view: BaseWeightSupersessionAuthorityView) -> None:
        ...
        try:
            ...
            raise BaseWeightSupersessionAuthorityIntegrityError(
                "base-weight supersession view was not issued by "
                "resolve_base_weight_supersession_authority"
            ) from exc
    ...
    def resolve(
        *,
        ...
        tenant_identity, study_identity, fields = (
            _resolve_base_weight_supersession_authority_state(
                principal=principal,
        ...
        view = object.__new__(BaseWeightSupersessionAuthorityView)
...
(
    _require_base_weight_supersession_view_issued,
    resolve_base_weight_supersession_authority,
) = _build_base_weight_supersession_view_runtime()
