...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("analytic_case_set_digest", "3" * 65),
        ("weight_eligibility_receipt_digest", "4" * 63),
        ("correction_sequence_digest", "5" * 65),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("analytic_case_set_digest", "3" * 63, ValueError),
        ("weight_eligibility_receipt_digest", "4" * 63, ValueError),
        ("correction_sequence_digest", "5" * 63, ValueError),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"analytic_case_set_digest": "c" * 64},
        {"weight_eligibility_receipt_digest": "d" * 64},
        {"correction_sequence_digest": "e" * 64},
