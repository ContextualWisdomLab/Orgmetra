...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"failed_evidence_reference": OTHER_FAILED_REFERENCE},
        {"failed_evidence_digest": "b" * 64},
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("failed_evidence_reference", "wrong:artifact", ValueError),
        ("failed_evidence_digest", "2" * 63, ValueError),
