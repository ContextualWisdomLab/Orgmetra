"""Fail when a shipped Keyverse integration symbol lacks a useful docstring."""
...
def _is_public(name: str) -> bool:
    """Return whether a symbol belongs to the documented public surface."""

    return not name.startswith("_")


def _missing_docstrings(path: Path) -> list[str]:
    """Return public symbols without non-empty docstrings in one module."""
