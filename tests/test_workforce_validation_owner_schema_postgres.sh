...
# The adoption phase runs after the protected foundation migration chain has
# created the legacy registry. Keeping it in this already-admitted isolated
# contract avoids a second CI orchestration path while preserving the bootstrap
# assertion above as an independently observable prerequisite.
