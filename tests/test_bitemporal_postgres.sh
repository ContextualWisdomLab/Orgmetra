...
INSERT INTO person_record (person_record_id)
VALUES ('00000000-0000-7000-8000-000000000001');
INSERT INTO organization_unit (organization_unit_id)
VALUES ('00000000-0000-7000-8000-000000000006');
INSERT INTO job_profile (job_profile_id)
...
INSERT INTO organization_unit_version (
    organization_unit_version_id, organization_unit_id, unit_name,
...
WHERE organization_unit_version_id = '00000000-0000-7000-8000-000000000013';
INSERT INTO organization_unit_version (
    organization_unit_version_id, organization_unit_id, unit_name,
    organization_type_code, effective_from, recorded_from
) VALUES (
...
WHERE organization_unit_id = '00000000-0000-7000-8000-000000000006'
...
WHERE organization_unit_version_id = '00000000-0000-7000-8000-000000000015';
"; } 2>&1)"
mutation_status=$?
set -e
...
INSERT INTO person_name_record (
    person_name_record_id, person_record_id, display_name, effective_from, recorded_from
) VALUES (
...
INSERT INTO job_profile_version (
    job_profile_version_id, job_profile_id, job_title, job_family_code,
