...
INSERT INTO product_composition_activation_evidence (
    evidence_bundle_sha256, deployment_id, environment_id, generation_id,
    config_sha256, authorization_action, authorized_state_sequence,
    ...
    repeat('7', 64), 'orgmetra_gateway', 'production', 'generation_one',
    repeat('a', 64), 'activate', 0,
    'v1.0.0', repeat('3', 64),
