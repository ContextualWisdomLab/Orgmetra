...
const REQUIRED_DISPATCHER_FILES = Object.freeze([
...
test('dispatcher migrations and execution contracts are provenance-required', () => {
  const nodeRequired = new Set(REQUIRED_FILES);
  const pythonRequired = pythonRequiredFiles();
  for (const filePath of REQUIRED_DISPATCHER_FILES) {
