...
async function main() {
  ...
  const [resultText, runtimeText, fixtureBytes] = await Promise.all([
  ...
  const acceptance = validateEmploymentSeparationAcceptance(resultText, runtimeEvidence, fixtureBytes);
