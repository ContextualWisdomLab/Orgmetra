...
test("rejects a fixture prepared after the measured run completed", () => {
  const performance = performanceResult();
  performance.completed_at = "2026-09-13T04:10:00.0001Z";
  const fixture = JSON.parse(FIXTURE_BYTES.toString("utf8"));
  fixture.prepared_at = "2026-09-13T04:10:00.0009Z";
  ...
  runtime.observed_at = "2026-09-13T04:10:00.001Z";

  assert.throws(
    () => validateEmploymentSeparationAcceptance(artifact, runtime, fixtureArtifact),
