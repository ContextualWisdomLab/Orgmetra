...
function writeMigrationBackedTables(root) {
  write(
    ...
    [
      ...
      'CREATE TABLE employment_work_capacity_record (tenant_record_id uuid NOT NULL);',
      'CREATE TABLE employment_work_capacity_version (tenant_record_id uuid NOT NULL);'
    ].join('\n') + '\n'
  );
}
