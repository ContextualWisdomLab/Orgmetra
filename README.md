...
This active PR adds governed People mutation and confirmed-hire materialization paths for Employment, Position, and Assignment with atomic audit/outbox evidence and tenant-scoped idempotency. Those write paths remain non-shipped active-PR evidence until this exact head passes fresh protected-base gates and merges.
